			...
			{#if isAuthenticated}
				<div class="mb-12 sm:mb-16 lg:mb-20">
					...
					<div class="grid gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4 xl:grid-cols-6">
						...
						<button
							onclick={() => goto('/dashboard')}
							class="group flex flex-col items-center rounded-xl border-0 bg-white/80 p-4 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none cursor-pointer"
						>
							<div
						...
						<button
							onclick={() => goto('/dashboard/profile')}
							class="group flex flex-col items-center rounded-xl border-0 bg-white/80 p-4 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none cursor-pointer"
						>
							<div
						...
						<button
							onclick={() => goto('/dashboard/settings')}
							class="group flex flex-col items-center rounded-xl border-0 bg-white/80 p-4 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none cursor-pointer"
						>
							<div
						...
						<button
							onclick={() => goto('/dashboard/connections')}
							class="group flex flex-col items-center rounded-xl border-0 bg-white/80 p-4 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none cursor-pointer"
						>
							<div
						...
						{#if isDeveloper}
							<button
								onclick={() => goto('/dashboard/clients')}
								class="group flex flex-col items-center rounded-xl border-0 bg-white/80 p-4 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:outline-none cursor-pointer"
							>
								<div
							...
							<button
								onclick={() => goto('/dashboard/oauth-tester')}
								class="group flex flex-col items-center rounded-xl border-0 bg-white/80 p-4 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none cursor-pointer"
							>
								<div
