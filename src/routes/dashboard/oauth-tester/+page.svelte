		...
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
			...
			<Card>
				...
				<div class="space-y-4">
					<!-- 클라이언트 선택 -->
					<div>
						<label class="mb-2 block text-sm font-medium text-gray-700">클라이언트 선택 *</label>
						...
						{:else if clients.length === 0}
							<div class="py-4 text-center text-gray-500">
								...
								활성화된 클라이언트가 없습니다.
								<a href="/dashboard/clients" class="ml-1 text-blue-600 hover:text-blue-800">
									클라이언트 생성하기
								</a>
							</div>
						{:else}
					...
					<!-- Response Type -->
					<div>
						<label class="mb-2 block text-sm font-medium text-gray-700">Response Type</label>
						<select
					...
					<!-- Scopes -->
					<div>
						<label class="mb-2 block text-sm font-medium text-gray-700">권한 범위 (Scopes)</label>
						<input
							type="text"
							bind:value={scopes}
			...
			<Card>
				...
				{:else}
					<div class="space-y-4">
						<!-- 생성된 URL -->
						<div>
							<label class="mb-2 block text-sm font-medium text-gray-700">생성된 인증 URL</label>
						...
						<!-- 파라미터 분석 -->
						<div>
							<label class="mb-2 block text-sm font-medium text-gray-700">URL 파라미터 분석</label>
							<div class="space-y-2">
								{#if generatedUrl}
